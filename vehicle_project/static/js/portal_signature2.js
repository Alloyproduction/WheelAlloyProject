...
//                    method: 'action_confirm_replica',
                 ...
                 if (data.error) {
                    ...
                    $confirm_btn.attr('disabled', false);
                     alert("Fail Car Comes In Route Stage ");
                }
                else if (data.success) {
                 alert("Complete Car Comes In Route Stage ");
                }
                });
            ...
            return rpc.query({
                ...
                if (data.error) {
                    ...
                    self.$('#o_portal_sign_draw').parent().replaceWith($succes);
                }
