...
#             }
    ...
    def action_quotation_send(self):
        ...
        str +=' class="btn btn-beta" target="_blank" style="color:white;font-size:13px;background-color:#875A7B;text-decoration:none;border-radius:5px;padding:8px 16px;">Confirm</a><br></p>'

        # self.full_url =str
        print(str)
        ir_model_data = self.env['ir.model.data']
        try:
            template_id = ir_model_data.get_object_reference('vehicle_project', 'email_template_edi_sale')[1]
        except ValueError:
            template_id = False
        try:
        ...
        # template =   self.env['mail.template'].browse(50)

        print(template)
        # template = template_id and self.env['mail.template'].browse(49)

        # temp=self.env['mail.template'].browse(49)
        # print(temp.body_html)
        tempBody=""
        tempBody= """<div style="text-align: right;"><span style="font-weight: bolder;"><span style="font-style: initial; font-variant-caps: initial; font-variant-ligatures: initial; text-align: inherit;"><font style="font-size: 14px;"> &#160; </font></span><span style="font-style: initial; font-variant-caps: initial; font-variant-ligatures: initial; text-align: inherit;"><font style="font-size: 14px;"> &#160; </font></span><span style="font-style: initial; font-variant-caps: initial; font-variant-ligatures: initial; text-align: inherit;"><font style="font-size: 14px;">${object.partner_id.name} &#160; </font></span><span style="font-style: initial; font-variant-caps: initial; font-variant-ligatures: initial; text-align: inherit;"><font style="font-size: 14px;">عزيزي &#160; </font></span></span></div><p style="margin-right: 0px; margin-left: 0px;"></p><ul style="font-family: &quot;Times New Roman&quot;; margin-right: 0px; margin-left: 0px;"></ul><ul style="font-family: &quot;Times New Roman&quot;; margin-right: 0px; margin-left: 0px;"></ul><div style="margin: 0px; padding: 0px;"><div style="text-align: right; margin: 0px; padding: 0px;"><div style="margin: 0px; padding: 0px;">,تحية طيبة <br/></div><div style="margin: 0px; padding: 0px;"><div style="margin: 0px; padding: 0px;"> &#160; شكرا لتواصلكم معنا واهتمامكم بخدمات شركة ألوي. مرفق لكم عرض الأسعار بناء على طلبكم للخدمات التي تم نقاشها &#160; <span style="font-style: initial; font-variant-ligatures: initial; font-variant-caps: initial; font-weight: initial;">مسبقا</span></div><h2 style="margin-right: 0px; margin-left: 0px; font-family: &quot;Lucida Grande&quot;, Helvetica, Verdana, Arial, sans-serif;"> &#160; <span style="color: rgb(0, 0, 0); font-size: 13px;">عند الموافقة على الأسعار المرفق يرجى الضغط على زر</span><font style="color: rgb(206, 0, 0); font-size: 36px;">" تأكيد"</font><span style="color: rgb(0, 0, 0); font-size: 13px;"> &#160;  الموضحة ادناه لإتمام مرحلة البيع الأوليه</span><font style="background-color: rgb(247, 247, 247); color: rgb(206, 0, 0); font-size: 24px;"></font></h2></div><div style="margin: 0px; padding: 0px;"> &#160; <span style="font-weight: bolder; text-align: inherit; font-style: initial; font-variant-ligatures: initial; font-variant-caps: initial;"><font style="font-size: 14px;"> &#160; </font></span><span style="font-weight: bolder; text-align: inherit; font-style: initial; font-variant-ligatures: initial; font-variant-caps: initial;"><font style="font-size: 14px;"> &#160; </font></span><span style="font-weight: bolder; text-align: inherit; font-style: initial; font-variant-ligatures: initial; font-variant-caps: initial;"><font style="font-size: 14px;">${object.offer_valid}</font></span><span style="font-style: initial; font-variant-ligatures: initial; font-variant-caps: initial; font-weight: initial;"> &#160; هذا العرض صالح لمدة</span></div><div style="margin: 0px; padding: 0px;"> <br/></div><div style="margin: 0px; padding: 0px;"> &#160; الهاتف المجاني: 920008422<br/></div><div style="margin: 0px; padding: 0px;"> &#160; info@alloywheel.sa</div><div style="margin: 0px; padding: 0px;"> &#160; </div></div></div><ol style="font-family: &quot;Times New Roman&quot;; margin-right: 0px; margin-left: 0px;"></ol><ol style="font-family: &quot;Times New Roman&quot;; margin-right: 0px; margin-left: 0px;"></ol><ul style="font-family: &quot;Times New Roman&quot;; margin-right: 0px; margin-left: 0px;"></ul><ul style="font-family: &quot;Times New Roman&quot;; margin-right: 0px; margin-left: 0px;"></ul><ol style="font-family: &quot;Times New Roman&quot;; margin-right: 0px; margin-left: 0px;"></ol><ol style="font-family: &quot;Times New Roman&quot;; margin-right: 0px; margin-left: 0px;"></ol><ul style="font-family: &quot;Times New Roman&quot;; margin-right: 0px; margin-left: 0px;"></ul><ul style="font-family: &quot;Times New Roman&quot;; margin-right: 0px; margin-left: 0px;"></ul><ul style="font-family: &quot;Times New Roman&quot;; margin-right: 0px; margin-left: 0px;"></ul><ul style="font-family: &quot;Times New Roman&quot;; margin-right: 0px; margin-left: 0px;"></ul><ul style="font-family: &quot;Times New Roman&quot;; margin-right: 0px; margin-left: 0px;"></ul><ul style="font-family: &quot;Times New Roman&quot;; margin-right: 0px; margin-left: 0px;"></ul><ul style="font-family: &quot;Times New Roman&quot;; margin-right: 0px; margin-left: 0px;"></ul><ol style="font-family: &quot;Times New Roman&quot;; margin-right: 0px; margin-left: 0px;"></ol><ol style="font-family: &quot;Times New Roman&quot;; margin-right: 0px; margin-left: 0px;"></ol><ol style="font-family: &quot;Times New Roman&quot;; margin-right: 0px; margin-left: 0px;"></ol><ul style="font-family: &quot;Times New Roman&quot;; margin-right: 0px; margin-left: 0px;"></ul><ol style="font-family: &quot;Times New Roman&quot;; margin-right: 0px; margin-left: 0px;"></ol><ul style="font-family: &quot;Times New Roman&quot;; margin-right: 0px; margin-left: 0px;"></ul><ul style="font-family: &quot;Times New Roman&quot;; margin-right: 0px; margin-left: 0px;"></ul><ul style="font-family: &quot;Times New Roman&quot;; margin-right: 0px; margin-left: 0px;"></ul><ul style="font-family: &quot;Times New Roman&quot;; margin-right: 0px; margin-left: 0px;"></ul><ol style="font-family: &quot;Times New Roman&quot;; margin-right: 0px; margin-left: 0px;"></ol><div style="text-align: right; margin: 0px; padding: 0px;"></div> <br/><div style="text-align: left; margin: 0px; padding: 0px;"><span style="font-weight: bolder;"><span style="font-style: initial; font-variant-caps: initial; font-variant-ligatures: initial; text-align: inherit;"><font style="font-size: 14px;">Dear &#160;  &#160; </font></span><span style="font-style: initial; font-variant-caps: initial; font-variant-ligatures: initial; text-align: inherit;"><font style="font-size: 14px;">${object.partner_id.name}</font></span><br/></span><br/><span style="font-style: initial; font-variant-caps: initial; font-variant-ligatures: initial; font-weight: initial;"><font style="font-size: 14px;">Thank you for your interests in AWRS Saudi Arabia!</font></span><br/></div><div style="text-align: left; margin: 0px; padding: 0px;"><font style="font-size: 14px;">Following our discussion, kindly find attached your quotation as per your request.</font></div><div style="text-align: left; margin: 0px; padding: 0px;"><font style="font-size: 14px;">Upon approval, please click on the &#160; </font><font style="color: rgb(206, 0, 0); font-size: 36px;">“Confirm”</font><font style="font-size: 14px;"> &#160; button below to initiate the Sale and coordination process for the free Pick-Up service.</font><font style="font-size: 14px;"></font></div><div style="text-align: left; margin: 0px; padding: 0px;"><font style="font-size: 14px;"><div>"This quotation &#160; is valid for &#160; <span style="font-style: initial; font-variant-ligatures: initial; font-variant-caps: initial; font-weight: initial; text-align: right;"> &#160; </span><span style="text-align: inherit; font-style: initial; font-variant-ligatures: initial; font-variant-caps: initial; font-weight: bolder;"><font style="font-size: 14px;">${object.offer_valid}</font></span></div></font><font style="font-size: 14px;">920008422</font></div><div style="text-align: left; margin: 0px; padding: 0px;"><font style="font-size: 14px;">info@alloywheel.sa</font> </div>"""
        ...
        ctx = {
            ...
            'custom_layout': "mail.mail_notification_borders", #mail.mail_notification_paynow
