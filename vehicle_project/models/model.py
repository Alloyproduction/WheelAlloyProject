...
#             }
    ...
    def action_quotation_send(self):
        ...
        try:
            template_id = ir_model_data.get_object_reference('sale', 'sale.__export__.product_template_110_9b398ec2')[1]
        except ValueError:
            template_id = False
        try:
