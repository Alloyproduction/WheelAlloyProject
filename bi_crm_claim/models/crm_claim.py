...
class crm_claim(models.Model):
 ...
 ############################################################################################3
    ...
    description_first_action = fields.Text('First Action Description ')
    description = fields.Text('Second Action Description')
    ...
    type_action = fields.Many2one('crm.claim.category', 'Final Action Type')
