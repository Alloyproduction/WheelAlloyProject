...
class HRProtection(models.Model):
    ...
    def emp_request_action(self):
        ...
        sub = _("Employee Protection Request - HrManager")
        content = _("Hello,<br>Mr/Mrs: <b>" + str(self.emp_id.name) + "</b> Has a <b>Protection</b> request requires your approve,"\
    ...
    def hr_administrator_action(self):
        ...
        sub = _("Employee Protection Request - HrAdmin")
        content = _("Hello,<br>Mr/Mrs: <b>" + str(self.emp_id.name) + "</b> Has a <b>Protection</b> request requires your approve,"\
                       "<br>May you check it please.. ")
