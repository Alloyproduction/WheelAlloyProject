...
class HRMandate(models.Model):
    ...
    def create(self, vals):
        ...
        if vals.get('name', _('New')) == _('New'):
            vals['name'] = self.env['ir.sequence'].next_by_code('hr.mandate') or _('New')
        res = super(HRMandate, self).create(vals)
        return res
    ...
    def emp_request_action(self):
        ...
        sub = _("Employee Mandate Request - HrManager")
        content = _("Hello,<br>Mr/Mrs: <b>" + str(self.emp_id.name) + "</b> Has a <b>Mandate</b> request requires your approve,"\
    ...
    def hr_administrator_action(self):
        ...
        sub = _("Employee Mandate Request - HrAdmin")
        content = _("Hello,<br>Mr/Mrs: <b>" + str(self.emp_id.name) + "</b> Has a <b>Mandate</b> request requires your approve,"\
                       "<br>May you check it please.. ")
